...
OUT = os.path.join(os.path.dirname(os.path.dirname(HERE)), "results", "问题二_改进方案")
Q2GEO = os.path.join(os.path.dirname(os.path.dirname(HERE)), "results", "问题二_参考口径", "有向航段几何参数.csv")
