"""从参考 PDF 第 20–21 页的 23 架次访问结构构造逐箱可检验的搜索起点。
...
# 每项为 (机型, (服务区, 本站箱数), ...)，顺序取参考 PDF 的架次列表。
TEMPLATE = [
    ("A", ("S002", 2), ("S012", 1)),
    ("A", ("S012", 2)),
    ("A", ("S002", 2)),
...
# 实际资源和开始时刻始终由解码器重新计算。
REFERENCE_STARTS = (0, 0, 0, 0, 0, 0, 0, 0, 1555, 1562, 1870, 1976,
                    2004, 2037, 3019, 3159, 3376, 3404, 3464, 3731, 4282, 4981, 5366)
